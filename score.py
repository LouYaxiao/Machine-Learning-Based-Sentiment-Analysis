...
doc_file_path = r"C:\Users\Lou13\Desktop\USnews中国与全球南方新闻文稿.doc"
...
for i, para in enumerate(doc.Paragraphs):
    ...
    if text:  # Ignore empty paragraphs
        ...
        results[f'Paragraph {i+1}'] = sentiment_score
...
results_df = pd.DataFrame(results.items(), columns=['Segment', 'Sentiment Score'])
